...
define('DIRETORIO_MODEL', dirname(__FILE__) . DIRECTORY_SEPARATOR . MODELS_PASTA . DIRECTORY_SEPARATOR);
define('DIRETORIO_REPOSITORIO', dirname(__FILE__) . DIRECTORY_SEPARATOR . REPOSITORIO_PASTA . DIRECTORY_SEPARATOR);
